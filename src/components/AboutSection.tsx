...
export function AboutSection() {
  ...
  return (
    ...
    >
      <FadeIn delay={0.1} x={-80} y={0} duration={0.9} className="absolute top-[4%] left-[1%] sm:left-[2%] lg:left-[4%] w-[120px] sm:w-[160px] md:w-[210px] lg:w-[260px] xl:w-[300px]">
      ...
      <FadeIn delay={0.25} x={-80} y={0} duration={0.9} className="absolute bottom-[8%] left-[3%] sm:left-[6%] lg:left-[10%] w-[100px] sm:w-[140px] md:w-[180px] lg:w-[220px] xl:w-[260px]">
      ...
      <FadeIn delay={0.15} x={80} y={0} duration={0.9} className="absolute top-[4%] right-[1%] sm:right-[2%] lg:right-[4%] w-[120px] sm:w-[160px] md:w-[210px] lg:w-[260px] xl:w-[300px]">
      ...
      <FadeIn delay={0.3} x={80} y={0} duration={0.9} className="absolute bottom-[8%] right-[3%] sm:right-[6%] lg:right-[10%] w-[130px] sm:w-[170px] md:w-[220px] lg:w-[260px] xl:w-[300px]">
